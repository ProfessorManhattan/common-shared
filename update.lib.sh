...
add_initctl () {
    npx --yes run-func ./.modules/shared/log.js info "Determining whether or not to copy initctl file"
    npx --yes run-func ./.modules/shared/log.js log "Copying initctl file"
    npx --yes run-func ./.modules/shared/log.js success "Copying initctl file"
    npx --yes run-func ./.modules/shared/log.js error "Copying initctl file"
    npx --yes run-func ./.modules/shared/log.js warn "Copying initctl file"
